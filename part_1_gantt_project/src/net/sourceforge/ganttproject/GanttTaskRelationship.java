...
//           successorTaskID   == compareRel.successorTaskID;
  ...
  public Object clone(){
	  try {
	        GanttTaskRelationship copyRel = (GanttTaskRelationship) super.clone();
	        copyRel.relationshipType = this.relationshipType;
	        copyRel.predecessorTaskID = this.predecessorTaskID;
	        copyRel.successorTaskID = this.successorTaskID;
	        return copyRel;
